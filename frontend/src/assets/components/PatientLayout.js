...
import {
  Calendar, Users, BookOpen, MessageCircle, Activity, HelpCircle, User, LogOut
} from 'lucide-react';
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg py-2 z-50">
          <button
            onClick={() => { setOpen(false); window.location.href = '/profile_patient'; }}
        ...
        <div className="mt-24 flex flex-col items-start pt-10 px-10 space-y-6">
          <Link to={'/dashboard_patient'} className='w-full'>
            <button className="flex items-center space-x-4 p-3 bg-white/90 text-gray-600 shadow-md rounded-xl w-full hover:bg-[#1C398E] hover:text-white cursor-pointer">
              <Calendar className="w-5 h-5" /><span className="text-sm font-medium">Calendar</span>
            </button>
          </Link>
          <Link to={'/chat_users'} className='w-full'>
            <button className="flex items-center space-x-4 p-3 bg-white text-gray-600 shadow-md rounded-xl w-full hover:bg-[#1C398E] hover:text-white cursor-pointer">
              <MessageCircle className="w-5 h-5" /><span className="text-sm font-medium">Messages</span>
            </button>
          </Link>
          <Link to={'/medical_records'} className='w-full'>
            <button className="flex items-center space-x-4 p-3 bg-white text-gray-600 shadow-md rounded-xl w-full hover:bg-[#1C398E] hover:text-white cursor-pointer">
              <BookOpen className="w-5 h-5" /><span className="text-sm font-medium">Records</span>
            </button>
          </Link>
          <Link to={'/view_doctors'} className='w-full'>
            <button className="flex items-center space-x-4 p-3 bg-white text-gray-600 shadow-md rounded-xl w-full hover:bg-[#1C398E] hover:text-white cursor-pointer">
              <Users className="w-5 h-5" /><span className="text-sm font-medium">Doctors</span>
            </button>
          </Link>
          <Link to={'/activity_user'} className='w-full'>
            <button className="flex items-center space-x-4 p-3 bg-white text-gray-600 shadow-md rounded-xl w-full hover:bg-[#1C398E] hover:text-white cursor-pointer">
              <Activity className="w-5 h-5" /><span className="text-sm font-medium">Activity</span>
            </button>
          </Link>
          <Link to={'/help_user'} className='w-full'>
            <button className="flex items-center space-x-4 p-3 bg-white text-gray-600 shadow-md rounded-xl w-full hover:bg-[#1C398E] hover:text-white cursor-pointer">
              <HelpCircle className="w-5 h-5" /><span className="text-sm font-medium">Help</span>
            </button>
          </Link>
        </div>
      </div>
      ...
      <div className="flex">
        ...
        <div className="hidden md:flex fixed top-0 left-0 h-full w-20 flex-col items-center py-10 space-y-6 bg-white/80 backdrop-blur-md shadow-lg z-40">
          <Link to={'/dashboard_patient'}>
            <button className="cursor-pointer mt-20 p-4 rounded-3xl bg-white/90 text-gray-500 shadow-md hover:bg-[#1C398E] hover:text-white"><Calendar className="w-5 h-5" /></button>
          </Link>
          <Link to={'/chat_users'}>
            <button className="cursor-pointer p-4 rounded-3xl bg-white text-gray-500 shadow-md hover:bg-[#1C398E] hover:text-white"><MessageCircle className="w-5 h-5" /></button>
          </Link>
          <Link to={'/medical_records'}>
            <button className="cursor-pointer p-4 rounded-3xl bg-white text-gray-500 shadow-md hover:bg-[#1C398E] hover:text-white"><BookOpen className="w-5 h-5" /></button>
          </Link>
          ...
          <Link to={'/activity_user'}>
            <button className="cursor-pointer p-4 rounded-3xl bg-white text-gray-500 shadow-md hover:bg-[#1C398E] hover:text-white"><Activity className="w-5 h-5" /></button>
          </Link>
          <Link to={'/help_user'}>
            <button className="cursor-pointer p-4 rounded-3xl bg-white text-gray-500 shadow-md mt-60 hover:bg-[#1C398E] hover:text-white"><HelpCircle className="w-5 h-5" /></button>
          </Link>
        </div>
