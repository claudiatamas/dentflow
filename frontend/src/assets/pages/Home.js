...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero */}
      <main id="home" className="flex justify-center items-center mt-0 sm:mt-8 mx-0 sm:mx-10 mb-32">
        <div className="flex w-full h-full gap-6 sm:gap-8 flex-col lg:flex-row">
          ...
          <div className="w-full h-[740px] sm:h-[680px] lg:w-7/12 bg-gradient-to-bl from-cyan-100 via-blue-50 to-indigo-50 p-4 sm:p-6 lg:p-10 rounded-none sm:rounded-xl shadow-md flex flex-col justify-center" style={{ fontFamily: 'Inter, sans-serif' }}>
            <h1 className="text-4xl sm:text-5xl mb-4 sm:mb-6 mx-4 sm:mx-10">
              Start Your <span className="text-[#369cf7]">Journey</span> to Smarter Dental Care with{' '}
              <span className="text-[#369cf7] font-handwriting text-5xl sm:text-7xl">Dentflow</span>
            </h1>
      ...
      {/* Sections with IDs for navbar scroll */}
      <div id="features"><Features /></div>
      <div id="blog"><BlogSection /></div>
      <AboutUs /> {/* AboutUs already has id="about" internally */}
      <Feedback />
